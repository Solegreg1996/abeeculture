  ...
  return (
    <main className="min-h-screen bg-[#FFF8E7] text-[#1F1A12]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 py-20 lg:grid-cols-2 lg:py-28">
          <div>
            <p className="mb-6 inline-flex rounded-full border border-[#E8D49C] bg-white px-5 py-2 text-xs font-bold uppercase tracking-[0.25em] text-[#8A5A00] shadow-sm">
              Beta privée · Alertes apicoles localisées
            </p>
            ...
            <p className="mt-8 max-w-2xl text-xl leading-9 text-[#5F5443]">
              Abeeculture aide les apiculteurs à suivre leurs ruchers selon
              leur localisation, les floraisons actives, la météo et les
              périodes clés de production.
            </p>

            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <a
                href="/signup"
                className="rounded-full bg-[#1F1A12] px-8 py-4 text-center text-sm font-semibold text-white shadow-lg transition hover:bg-[#3A3122]"
              >
                Créer mon compte beta
              </a>

              <a
                href="/login"
                className="rounded-full bg-white px-8 py-4 text-center text-sm font-semibold text-[#1F1A12] shadow-sm transition hover:bg-[#FFF1BF]"
              >
                Se connecter
              </a>
            </div>

            <div className="mt-10 flex flex-wrap gap-3 text-sm text-[#5F5443]">
              <span className="rounded-full bg-white px-4 py-2 shadow-sm">
                🌸 Floraisons localisées
              </span>
          ...
          <div className="rounded-[2rem] bg-white p-5 shadow-2xl">
            <div className="rounded-[1.5rem] bg-[#1F1A12] p-6 text-white">
              <div className="mb-6 flex items-center justify-between">
                <div>
                  <p className="text-sm text-[#F7D774]">
                    Rucher sélectionné
                  </p>
      ...
      >
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-3 max-w-3xl text-4xl font-bold tracking-tight">
            Une plateforme pensée autour de vos ruchers.
          </h2>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              {
                title: "Floraisons régionales",
                text: "Visualisez les fleurs réellement actives selon la zone florale et la saison.",
              },

              {
                title: "Scoring apicole",
                text: "Suivez météo, nectarification et risque d’essaimage pour anticiper les périodes clés.",
              },
            ].map((feature) => (
              <div
                key={feature.title}
              ...
              >
                ...
                <p className="mt-4 leading-7 text-[#5F5443]">
                  {feature.text}
                </p>
              </div>
            ))}
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <div>
              ...
              <p className="mt-3 text-white/70">
                Indiquez simplement la ville, le nombre de ruches et la force estimée des colonies.
              </p>
            </div>
            ...
            <div>
              ...
              <h3 className="mt-4 text-xl font-bold">
                Suivez les floraisons
              </h3>

              <p className="mt-3 text-white/70">
                Abeeculture adapte automatiquement les fleurs selon la région et la saison.
              </p>
            </div>
            ...
            <div>
              ...
              <h3 className="mt-4 text-xl font-bold">
                Anticipez les périodes clés
              </h3>

              <p className="mt-3 text-white/70">
                Suivez météo, nectarification et risques pour mieux piloter vos ruchers.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-4xl rounded-[2rem] bg-[#FFF8E7] p-10 text-center shadow-sm">
          <p className="text-xs font-bold uppercase tracking-[0.25em] text-[#B47A00]">
            Beta privée
          </p>

          <h2 className="mt-4 text-4xl font-black tracking-[-0.04em]">
            Commencez à tester Abeeculture
          </h2>

          <p className="mt-5 text-lg leading-8 text-[#5F5443]">
            Créez votre compte, ajoutez vos ruchers et découvrez les premières
            floraisons localisées selon votre environnement.
          </p>

          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            <a
              href="/signup"
              className="rounded-full bg-[#1F1A12] px-8 py-4 text-sm font-semibold text-white shadow-lg transition hover:bg-[#3A3122]"
            >
              Créer mon compte beta
            </a>
            ...
            <a
              href="/login"
              className="rounded-full bg-white px-8 py-4 text-sm font-semibold text-[#1F1A12] shadow-sm transition hover:bg-[#FFF1BF]"
            >
              Se connecter
            </a>
          </div>
