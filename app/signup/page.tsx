    ...
    <main className="min-h-screen bg-[#FFF8E7] px-6 py-12 text-[#1F1A12]">
      <div className="mx-auto max-w-xl rounded-[2rem] bg-white p-8 shadow-xl">
        ...
        <p className="mt-3 text-[#5F5443]">
          Créez votre espace Abeeculture pour ajouter vos ruchers, suivre les
          floraisons locales et tester les premières alertes apicoles.
        </p>
        ...
        <form onSubmit={handleSignup} className="mt-8 grid gap-4">
          ...
          <button
            ...
            className="rounded-full bg-[#1F1A12] px-7 py-4 font-semibold text-white disabled:opacity-60"
          >
            {status === "loading" ? "Création..." : "Créer mon compte beta"}
          </button>
        ...
        <p className="mt-6 text-center text-sm text-[#5F5443]">
          Déjà un compte ?{" "}
          <a href="/login" className="font-bold text-[#B47A00]">
            Se connecter
          </a>
        </p>
      </div>
